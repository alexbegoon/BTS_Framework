 ...
 */
class BTS_Controller_Action_Helper_SendFile extends Zend_Controller_Action_Helper_Abstract
{
    /**
     * Set cache headers
     *
     ...
     */
    public function sendFile($path, $type = null, $options = array())
    {
        $response = $this->getResponse();
     ...
     * @return bool Whether the headers and file were sent
     */
    public function direct($path, $type = null, $options = array())
    {
