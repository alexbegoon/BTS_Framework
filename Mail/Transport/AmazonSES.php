 ...
 */
class BTS_Mail_Transport_AmazonSES extends Zend_Mail_Transport_Abstract
{
    /**
    ...
    public function _sendMail()
    {
        ...
        $client->setHeaders(array(
            ...
            'Return-Path' => $this->_mail->getReturnPath(),
            'From' => $headers['From'],
        ));
        ...
        $this->_mail->setMessageId($responseXml->SendRawEmailResult->MessageId);
    }
